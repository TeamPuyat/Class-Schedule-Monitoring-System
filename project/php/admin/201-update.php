        ...
        $query1=mysqli_query($db, $day1);
            if($query1){
                while($row1 = mysqli_fetch_array($query1, MYSQLI_NUM)){
                    ...
                    $yr1 = $row1[8];
                    if($row1[2]==73000){
                        $td1="<td $haha1>$sec1<br>$ins1<br>$dep1<br>$sc1<br>$yr1<br>
                        <a href='update.php?Day=$row1[0]&&Time_start=$row1[2]'>Update</a>
        ...
        $query1_7=mysqli_query($db, $day1_7);
            if($query1_7){
                while($row1_7 = mysqli_fetch_array($query1_7, MYSQLI_NUM)){
                    ...
                    $yr1_7 = $row1_7[8];
                    if($row1_7[2]==110000){
                        $td1_7="<td $haha1_7>$sec1_7<br>$ins1_7<br>$dep1_7<br>$sc1_7<br>$yr1_7<br>
                        <a href='update.php?Day=$row1_7[0]&&Time_start=$row1_7[2]'>Update</a>
                        <a href='delete.php'>Delete</a> 
                        </td>";
                        break;
                    }
